            ...
            <Layout>
                <section className="hero home">
                    <div className="container">
                        <h1>Weekend Labs is a full-service software consultancy, working closely with founders and
                            innovators to build the internet companies of tomorrow.</h1>
                    </div>
                </section>
                <section className="bullets">
                    <div className="container">
                        ...
                        <ul className="bullets__list">
                            ...
                            <li>
                                <Link href="https://github.com/weekendlabsllc/skeleton" target="_blank">
                                    Skeleton
                                </Link>
                ...
                <section className="about">
                    <div className="container">
                        ...
                        <p>Weekend Labs is a software consulting and investment collective based in Boston. Founded in
                            2021, Weekend Labs is a tight-knit collective of industry insiders, analysts, and
                            innovators. We are open, collaborative, and use our collective experience, design and
                            technical expertise to create meaningful and compelling content for all mediums. We take a
                            hands-on approach to consulting in a way that truly feels like a business partner.</p>
